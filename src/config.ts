...
export const siteConfig: SiteConfig = {
	title: "Geinka's Blog",
	subtitle: "Somethine about me...",
	siteURL: "https://kazepu.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2023-12-24", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "1085387763", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/kazepu/",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1085387763",
					external: true,
